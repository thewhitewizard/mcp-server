...
// FrozenOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function FrozenOf(address tokenOwner) view returns(uint256 balance)
func (_Token *TokenCaller) FrozenOf(opts *bind.CallOpts, tokenOwner common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "frozenOf", tokenOwner)
...
//
// Solidity: function FrozenOf(address tokenOwner) view returns(uint256 balance)
func (_Token *TokenSession) FrozenOf(tokenOwner common.Address) (*big.Int, error) {
	return _Token.Contract.FrozenOf(&_Token.CallOpts, tokenOwner)
}

// FrozenOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function FrozenOf(address tokenOwner) view returns(uint256 balance)
func (_Token *TokenCallerSession) FrozenOf(tokenOwner common.Address) (*big.Int, error) {
	return _Token.Contract.FrozenOf(&_Token.CallOpts, tokenOwner)
}
